          ...
          <div class="slide_1 owl-carousel owl-theme">
            <div class="item">
              <div class="portfolio_sec">
                <img src="<?= base_url('assets/images/akademik/jadwal_seminar_tesis_1.jpg') ?>" class="img-fluid " alt="">
              </div>
            </div>
            <div class="item">
              <div class="portfolio_sec">
                <img src="<?= base_url('assets/images/akademik/jadwal_seminar_tesis_2.jpg') ?>" class="img-fluid " alt="">
              </div>
            </div>
          </div>
        </div>
